...
function AddDoctor() {
    ...
    const onsubmitHandler = async (event) => {
        ...
        try {
            ...
            formData.append('imageUpload', docImg)
    ...
    return (
        <form onSubmit={onsubmitHandler} className='m-5 w-full'>
            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll scroll-smooth'>
                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        <div className='flex-1 flex flex-col gap-1'>
                            ...
                            <select onChange={(e) => setSpeciality(e.target.value)} value={speciality} className='border rounded px-3 py-2' name="" id="">
                                ...
                                <option value="Neurologist">General Physician</option>
                ...
                <button type='submit' className='bg-blue-400 px-10 py-3 mt-4 text-white rounded-full hover:cursor-pointer'>
                    Add Doctor
                </button>
